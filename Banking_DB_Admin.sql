...
PROCEDURE INSERT_ACC(A_ACC_NO IN ACCOUNT.ACC_NO%TYPE, 
    ...
    A_TYPE IN ACCOUNT.TYPE%TYPE, 
    A_STATUS IN ACCOUNT.STATUS%TYPE, 
    A_BALANCE IN ACCOUNT.BALANCE%TYPE) AS
BEGIN 	
	INSERT INTO ACCOUNT (ACC_NO, CUST_ID, TYPE, STATUS, BALANCE) 
	VALUES (A_ACC_NO, A_CUST_ID, A_TYPE, A_STATUS, A_BALANCE);
END;
...
PROCEDURE INSERT_TRANS(T_TRANS_ID IN TRANSACTION.TRANS_ID%TYPE, 
    T_ACC_NO IN INT, 
    T_TYPE  IN TRANSACTION.TYPE%TYPE, 
    T_TRANS_DATE IN DATE, 
    T_AMOUNT IN TRANSACTION.AMOUNT%TYPE,
    T_DEBIT_CREDIT_FLAG IN NUMBER) AS
BEGIN 	
	INSERT INTO TRANSACTION (TRANS_ID, ACC_NO, TYPE, TRANS_DATE, AMOUNT, DEBIT_CREDIT_FLAG) 
	VALUES (T_TRANS_ID, T_ACC_NO, T_TYPE, T_TRANS_DATE, T_AMOUNT, T_DEBIT_CREDIT_FLAG);
END;
